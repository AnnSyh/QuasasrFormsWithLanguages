...
export default defineConfig((ctx) => {
  return {
    ...
    framework: {
      config: {
		brand: {
			primary: '#1976D2', // Пример цвета
			secondary: '#26A69A', // Пример цвета
			accent: '#9C27B0', // Пример цвета
			positive: '#21BA45', // Пример цвета
			negative: '#C10015', // Пример цвета
			info: '#31CCEC', // Пример цвета
			warning: '#F2C037', // Пример цвета
		  },
      ...
      // Quasar plugins
      plugins: ['Dark'], // Включаем плагин Dark
    },
